...
```{python}
#| output: asis
if scaffold and glob.glob(f"{log_path}/*-scaffolded-default_merquryfk.completeness.stats"):
    print(
        pd.read_csv(
...
```{python}
#| output: asis
if scaffold and glob.glob(f"{log_path}/*-scaffolded-default_merquryfk.qv"):
    print(
        pd.read_csv(
...
if scaffold and glob.glob(f"{log_path}/*-scaffolded-default_merquryfk.spectra-cn.st.png"):
...
```{python}
if scaffold and glob.glob(f"{log_path}/*-scaffolded-default_merqury.spectra-cn.st.png"):
...
if scaffold and glob.glob(f"{log_path}/*-scaffolded-default_merquryfk.spectra-asm.st.png"):
...
```{python}
if scaffold and glob.glob(f"{log_path}/*-scaffolded-default_merqury.spectra-asm.st.png"):
...
```{python}
#| output: asis
if scaffold and glob.glob(f"{log_path}/*-scaffolded-default_merquryfk.false_duplications.tsv"):
    print(
        pd.read_csv(
